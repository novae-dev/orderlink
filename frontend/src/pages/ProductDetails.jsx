        ...
        <section className="product-detail">
          ...
          <div className="product-detail-info">
            ...
            <p className="product-description">
              ...
              {' '}
              available through OrderLink. Connect with the seller and arrange a convenient campus delivery or pickup.
              {' '}
            </p>
            {' '}
            ...
            <div className="purchase-row">
              ...
              {' '}
              <button className="product-heart"> <Heart size={19} /> </button>
              {' '}
            </div>
            {' '}
